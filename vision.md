...
> **Positioning:** An open-source, self-hostable reading workspace for PDFs, articles, and technical documents.

---

## The Magic Moment

Upload a 120-page PDF.

Thirty seconds later you already know whether it's worth reading, what it's about, and where to start.

That's the product. Everything else supports that.
...
Every major tool fails in at least one dimension:

- **Pocket / Instapaper** — great for articles, treat PDFs as attachments, no AI
- **Readwise Reader** — closest competitor, closed-source, no self-hosting, expensive
- **NotebookLM / ChatGPT Projects** — AI-first but not a reading experience, no queue or library
...
| Zotero | Research-grade | Far easier to use, modern UX |
| Obsidian | Note-taking depth | Built for reading first, not writing |
| Omnivore (defunct) | Open source | It's alive. With AI. |

---

## Who It's For

- **Researchers / academics** — papers, textbooks, preprints
- **Developers / engineers** — RFCs, technical docs, architecture papers
- **Students** — textbooks and assigned readings they need to actually understand
- **Lawyers / analysts** — long-form document review
- **Self-hosters** — data ownership, no vendor lock-in
- **Omnivore refugees** — the community is active, warm, and looking
...
- Everything in one place — PDFs, articles, highlights, notes, AI conversations, all connected
...
The open-source reading workspace for PDFs,
